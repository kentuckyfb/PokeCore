// components/ModifiedBentoBoxes.tsx
'use client';
...
interface ModifiedBentoBoxesProps {
  pokemon: Pokemon;
...
const ModifiedBentoBoxes: React.FC<ModifiedBentoBoxesProps> = ({ pokemon, species, loadPokemon }) => {
  ...
  return (
    <div className="w-full">
      {/* Main grid with more prominent layout */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* First row - Main Information - 2 columns wide */}
        ...
        {/* FEATURED BOXES - Here we put Type Matchups and Evolution Chain side by side */}
        <motion.div className="bento-box p-4" layout>
          <motion.h3 className="text-lg font-bold mb-2 flex items-center" style={{ color: typeColor }} layout>
        ...
        {/* Evolution Chain Box */}
        <motion.div className="bento-box p-3" layout>
        ...
        {/* Stats Box (Using Radar Chart) - 2 columns wide */}
...
export default ModifiedBentoBoxes;